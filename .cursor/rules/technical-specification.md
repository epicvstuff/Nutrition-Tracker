...
This rule provides the technical architecture and specifications for the Nutrition Tracker application.
...
4. Setting up new components
5. Planning technical improvements 